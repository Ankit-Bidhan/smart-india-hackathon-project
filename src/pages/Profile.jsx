...
function Profile() {
    ...
    const handleGuidePhoto = (event) => {
        ...
        if (guidePhotoPreview) {
            URL.revokeObjectURL(guidePhotoPreview);
        }
    ...
    const handleApplication = async (event) => {
        ...
        try {
            ...
            formData.append("file", guidePhoto);
            ...
            const applicationData = {
                ...
                city: guideForm.city.trim(),

                state: guideForm.state.trim(),
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="guide-form-note">
                                ...
                                reviewed by the TravelEase admin
                                team before your guide profile
                                becomes public.
                            </p>
